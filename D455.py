...
# pandaId = p.loadURDF("franka_panda/panda.urdf", [0, 0, 0])
...
def get_end_effector_position(robot):
    # The link id for the end effector depends on your robot
    ...
    if start:
        ...
        if results.multi_hand_landmarks:
            for handLms in results.multi_hand_landmarks:
                ...
                # print(initial_depth, wrist_depth)
                ...
                # print(handLms.landmark[4].y < handLms.landmark[0].y)
                ...
                if fist == 0:
                    ...
                    for id, lm in enumerate(handLms.landmark):
                        ...
                        if id == 20:
                            pinky_x = cx
                            pinky_y = cy
                        # cv2.circle(color_image, (cx, cy), 3, (255, 0, 255), cv2.FILLED)
